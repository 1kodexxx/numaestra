...
func (r *wOrderRepo) GetByDemoInvoiceID(_ context.Context, inv int64) (*domain.Order, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *wOrderRepo) ApplyDemoPaymentSuccess(_ context.Context, o *domain.Order) (bool, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
