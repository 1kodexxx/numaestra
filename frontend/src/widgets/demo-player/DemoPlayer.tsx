...
// Частая причина отказа — упоминание РЕАЛЬНОГО артиста или бренда в тексте
// (ИИ-студия такое не генерирует). Та же причина сорвёт и платную генерацию,
// поэтому НЕ зовём оплачивать «как есть» — просим поправить текст или написать нам.
function DemoFailed() {
  return (
    <Shell>
      <div style={{ display: 'flex', alignItems: 'center', gap: '9px', marginBottom: '6px' }}>
        <DemoBadge label="Демо" />
        <span style={{ fontSize: '13px', fontWeight: 700 }}>Не удалось создать демо</span>
      </div>
      <div style={{ fontSize: '12px', color: TEXT2, lineHeight: 1.55 }}>
        Чаще всего это из-за <b style={{ color: ACCENT }}>имён реальных артистов или названий брендов</b> в
        тексте — ИИ-студия такие песни не создаёт. Уберите их и оформите новый заказ,
        или{' '}
        <a href="/legal/contacts" style={{ color: ACCENT, fontWeight: 600 }}>напишите нам</a>{' '}
        — поможем.
      </div>
    </Shell>
  )
