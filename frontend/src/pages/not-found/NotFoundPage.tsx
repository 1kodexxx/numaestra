...
export function NotFoundPage() {
  ...
  return (
    <div className="fade-in" style={{
      ...
      <div className="scale-in gradient-text" style={{ fontSize: 'clamp(64px, 18vw, 96px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1 }}>
        404
      </div>
      <div className="fade-up hero-enter-d1" style={{ fontSize: 'clamp(18px, 4vw, 22px)', fontWeight: 800, letterSpacing: '-0.02em', marginTop: '8px' }}>
        Такой страницы нет
      </div>
      <div className="fade-up hero-enter-d2" style={{ fontSize: '14px', color: TEXT2, maxWidth: '360px', lineHeight: 1.6, marginBottom: '20px' }}>
        Возможно, ссылка устарела или содержит опечатку. Вернитесь на главную и соберите свою песню.
      </div>
      <div className="fade-up hero-enter-d3" style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', justifyContent: 'center' }}>
